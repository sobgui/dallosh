...
async def run_bot(transport: BaseTransport, data = {}):
    ...
    llm = GeminiMultimodalLiveLLMService(
        ...
        system_instruction=system_instructions if system_instructions else SYSTEM_INSTRUCTIONS,
...
# Moved event handler inside run_bot function for proper variable access
