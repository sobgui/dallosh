...
import type { Table } from "@/lib/sodular/types/schema/tables.schema";
...
export default function ConstraintsPage() {
  ...
  const [schemaCollection, setSchemaCollection] = useState<Table | null>(null);
  const [relationshipsCollection, setRelationshipsCollection] = useState<Table | null>(null);
